...
<disk type='file' device='disk'>
  ...
  <serial>nixmywindows-root</serial>
</disk>
```

This creates `/dev/disk/by-id/virtio-nixmywindows-root` inside the VM,
...
After installation, the flake is copied to `/etc/nixmywindows` and `/home/user/nixmywindows`. To make changes:

- Edit the flake in `/home/user/nixmywindows`
- Rebuild with `sudo nixos-rebuild switch --flake /home/user/nixmywindows#<hostname>`
...
6. Rebuild: `nixos-rebuild boot --flake /etc/nixmywindows#<hostname>`
